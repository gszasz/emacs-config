(custom-set-variables
 ...
 '(package-selected-packages
   '(ada-mode adaptive-wrap apache-mode csv-mode ein elpy flyspell-correct-ivy gnuplot ivy-bibtex magit-section markdown-mode ob-async olivetti org-gtd org-remark php-mode pygn-mode stripes syslog-mode use-package visual-fill-column whitespace-cleanup-mode yascroll))
