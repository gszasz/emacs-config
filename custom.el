(custom-set-variables
 ...
 '(package-selected-packages
   '(ada-mode adaptive-wrap apache-mode csv-mode cython-mode elpy flycheck-hledger flyspell-correct-ivy git-modes gitignore-templates gnuplot go-eldoc go-mode hledger-mode ivy-bibtex markdown-mode ob-async org-gtd php-mode pip-requirements pkg-info pygn-mode stripes syslog-mode visual-fill-column whitespace-cleanup-mode whole-line-or-region yascroll))
