;;; pastebin.el --- A simple interface to the Pastebin webservice

;;; Copyright (C) 2016 by Gabriel Szasz <gszasz@redhat.com>

;;; Based on Pastebin <https://www.emacswiki.org/emacs/pastebin>.
...
(defcustom pastebin-domain-versions '(("pastebin.com" "/api_public.php")
                                      ("pastebin.test.redhat.com" "/pastebin.php"))
  ...
  (let* ((path (cadr (assoc domain pastebin-domain-versions)))
         ...
         (url-request-data
          (concat (format
                   ...
                   (url-hexify-string (user-login-name))
