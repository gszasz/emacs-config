...
;; It was initially developed by Yoshiki Kurihara and many features were added
;; by Marshall Vandegrift.  As YAML and Python share the fact that indentation
...
;; YAML is easy to write but complex to parse, and this mode doesn't even really
;; try.  Indentation and highlighting will break on abnormally complicated
;; structures.
